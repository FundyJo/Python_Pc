...
setTitle("Prophecy v1.0.0 | Current Type Beta")
...
{m}[{w}1{Fore.RESET}{m}]{Fore.RESET} Root Forcer     {b}|{Fore.RESET}{m}[{w}9{Fore.RESET}{m}]{Fore.RESET}  Channel Spammer   {b}|{Fore.RESET}{m}[{w}17{Fore.RESET}{m}]{Fore.RESET} Patch Notes{Fore.RESET}         {b}|{Fore.RESET}{m}[{w}25{Fore.RESET}{m}]{Fore.RESET} Token Generator{Fore.RESET}
...
#   NITRO GENERATOR
if choice == '1':
    setTitle(f"Wifi Cracked | v1.0.0 by FundyJo | only Linux!  ")
